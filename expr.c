...
/*
 ...
 (Note that most of these operators have special meaning to psh, and an
     ...
     char *expr;
{
  ...
  /*TAG:psh-5.3 make it clear that these are arithmetic syntax errors */
  if (curtok != 0)
...
readtok ()
{
  ...
  if (legal_variable_starter (c))
...
#endif
	{
	  ...
	  /* TAG:psh-5.3 add gettext calls here or make this a separate function */
	  if (c == '-')
