...
extern void unset_psh_input PARAMS((int));
...
/* Functions from the psh library, lib/sh/libsh.a.  These should really
...
extern void sbrand PARAMS((unsigned long));		/* set psh random number generator. */
