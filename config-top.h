...
#define DEFAULT_LOADABLE_BUILTINS_PATH \
  "/usr/local/lib/psh:/usr/lib/psh:/opt/local/lib/psh:/usr/pkg/lib/psh:/opt/pkg/lib/psh:."
#endif
...
#define DEFAULT_BASHRC "~/.pshrc"

/* System-wide .pshrc file for interactive shells. */
/* #define SYS_BASHRC "/etc/psh.pshrc" */

/* System-wide .psh_logout for login shells. */
/* #define SYS_BASH_LOGOUT "/etc/psh.psh_logout" */

/* Define this to make non-interactive shells begun with argv[0][0] == '-'
   run the startup files when not in posix mode. */
/* #define NON_INTERACTIVE_LOGIN_SHELLS */

/* Define this if you want psh to try to check whether it's being run by
   sshd and source the .pshrc if so (like the rshd behavior).  This checks
...
/* Define if you want each line saved to the history list in pshhist.c:
   psh_add_history() to be sent to syslog(). */
...
/* Define to 1 if you want to optimize for sequential array assignment when
   using indexed arrays, 0 if you want psh-4.2 behavior, which favors
