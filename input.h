...
extern int psh_input_fd_changed;
...
#if defined (BUFFERED_INPUT)
/* Functions from input.c. */
extern int fd_is_psh_input PARAMS((int));
extern int set_psh_input_fd PARAMS((int));
extern int save_psh_input PARAMS((int, int));
extern int check_psh_input PARAMS((int));
