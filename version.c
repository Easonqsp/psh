...
const char * const psh_copyright = N_("Copyright (C) 2022 Free Software Foundation, Inc.");
const char * const psh_license = N_("License GPLv3+: GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>\n");

/* If == 31, shell compatible with psh-3.1, == 32 with psh-3.2, and so on */
