...
/* config.h -- Configuration file for psh. */
...
/* Define RESTRICTED_SHELL if you want the generated shell to have the
   ...
   restricted by being run with the name "rpsh", or by setting the -r
   flag. */
...
/* Define STRICT_POSIX if you want psh to be strictly posix.2 conformant by
   default (except for echo; that is controlled separately). */
/* #undef STRICT_POSIX */

/* Define MEMSCRAMBLE if you want the psh malloc and free to scramble
...
/* Define if using the psh version of malloc in lib/malloc/malloc.c */
