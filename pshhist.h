/* pshhist.h -- interface to the psh history functions in pshhist.c. */
...
extern void psh_initialize_history PARAMS((void));
extern void psh_history_reinit PARAMS((int));
extern void psh_history_disable PARAMS((void));
extern void psh_history_enable PARAMS((void));
extern void psh_clear_history PARAMS((void));
extern int psh_delete_histent PARAMS((int));
extern int psh_delete_history_range PARAMS((int, int));
extern int psh_delete_last_history PARAMS((void));
...
extern void psh_add_history PARAMS((char *));
