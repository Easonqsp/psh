# Makefile for psh-5.2, version 5.1
#
...
PACKAGE_BUGREPORT = bug-psh@gnu.org
PACKAGE_NAME = psh
PACKAGE_STRING = psh 5.2-release
...
topdir = .
BUILD_DIR = /src/psh-5.2.15
top_builddir = /src/psh-5.2.15
srcdir = .
...
DEBUGGER_START_FILE = ${datadir}/pshdb/pshdb-main.inc
...
VERSPROG = pshversion$(EXEEXT)
VERSOBJ = pshversion.$(OBJEXT)
...
# we assume for now that readline source is being shipped with psh
...
CSOURCES = shell.c eval.c parse.y general.c make_cmd.c print_cmd.c y.tab.c \
	   ...
	   input.c pshhist.c array.c arrayfunc.c assoc.c sig.c pathexp.c \
	   unwind_prot.c siglist.c pshline.c bracecomp.c error.c \
...
HSOURCES = shell.h flags.h trap.h hashcmd.h hashlib.h jobs.h builtins.h \
	   ...
	   command.h input.h error.h pshansi.h dispose_cmd.h make_cmd.h \
	   subst.h externs.h siglist.h pshhist.h pshline.h pshtypes.h \
	   array.h arrayfunc.h sig.h mailcheck.h pshintl.h pshjmp.h \
...
INSTALLED_HEADERS = shell.h pshjmp.h command.h syntax.h general.h error.h \
		    variables.h array.h assoc.h arrayfunc.h quit.h dispose_cmd.h \
		    make_cmd.h subst.h sig.h externs.h builtins.h \
		    pshtypes.h xmalloc.h config-top.h config-bot.h \
		    pshintl.h pshansi.h pshjmp.h alias.h hashlib.h \
		    conftypes.h unwind_prot.h jobs.h siglist.h \
		    execute_cmd.h
INSTALLED_BUILTINS_HEADERS = pshgetopt.h common.h getopt.h
...
OBJECTS	 = shell.o eval.o y.tab.o general.o make_cmd.o print_cmd.o $(GLOBO) \
	   ...
	   alias.o $(ARRAY_O) arrayfunc.o assoc.o braces.o bracecomp.o pshhist.o \
	   pshline.o $(SIGLIST_O) list.o stringlib.o locale.o findcmd.o redir.o \
...
BUILTIN_C_SRC  = $(DEFSRC)/mkbuiltins.c $(DEFSRC)/common.c \
		 ...
		 $(DEFSRC)/pshgetopt.c $(GETOPT_SOURCE)
BUILTIN_C_OBJ  = $(DEFDIR)/common.o $(DEFDIR)/evalstring.o \
		 $(DEFDIR)/evalfile.o $(DEFDIR)/pshgetopt.o
...
.made: $(Program) pshbug $(SDIR)/man2html$(EXEEXT)
...
pshbug: $(SDIR)/pshbug.sh $(VERSPROG)
...
pshversion$(EXEEXT): buildversion.o $(SUPPORT_SRC)pshversion.c
	$(CC_FOR_BUILD) $(CCFLAGS_FOR_BUILD) ${LDFLAGS_FOR_BUILD} -o $@ $(SUPPORT_SRC)pshversion.c buildversion.o ${LIBS_FOR_BUILD}

buildversion.o: $(srcdir)/version.c
	$(CC_FOR_BUILD) $(CCFLAGS_FOR_BUILD) -DBUILDTOOL -c -o $@ $(srcdir)/version.c

buildversion.o: pshintl.h $(BASHINCDIR)/gettext.h
...
mksyntax$(EXEEXT):	${srcdir}/mksyntax.c config.h syntax.h ${BASHINCDIR}/chartypes.h pshansi.h
	$(RM) $@
...
${DEFDIR}/pshgetopt.o:	$(BUILTIN_SRCDIR)/pshgetopt.c
	@(cd $(DEFDIR) && $(MAKE) $(MFLAGS) DEBUG=${DEBUG} pshgetopt.o) || exit 1
...
install:	.made installdirs
	...
	$(INSTALL_SCRIPT) $(INSTALLMODE2) pshbug $(DESTDIR)$(bindir)/pshbug
...
install-headers: install-headers-dirs
	...
	-$(INSTALL_DATA) $(SDIR)/psh.pc $(DESTDIR)$(pkgconfigdir)/psh.pc
...
uninstall-headers:
	...
	-( $(RM) $(DESTDIR)$(pkgconfigdir)/psh.pc )

uninstall:	.made
	$(RM) $(DESTDIR)$(bindir)/$(Program) $(DESTDIR)$(bindir)/pshbug
...
# shell basics
copy_cmd.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
copy_cmd.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
copy_cmd.o: pshansi.h assoc.h $(BASHINCDIR)/ocache.h $(BASHINCDIR)/chartypes.h
dispose_cmd.o: pshansi.h ${BASHINCDIR}/ansi_stdlib.h
dispose_cmd.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h
dispose_cmd.o: error.h general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
error.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h flags.h ${BASHINCDIR}/stdc.h error.h
error.o: command.h general.h xmalloc.h externs.h input.h pshhist.h
error.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
error.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
eval.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h trap.h flags.h ${DEFSRC}/common.h
eval.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
eval.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
eval.o: pshhist.h assoc.h ${BASHINCDIR}/ocache.h ${BASHINCDIR}/chartypes.h
execute_cmd.o: config.h pshtypes.h ${BASHINCDIR}/filecntl.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
execute_cmd.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
execute_cmd.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
execute_cmd.o: pshhist.h input.h ${GRAM_H} assoc.h hashcmd.h alias.h
execute_cmd.o: ${BASHINCDIR}/ocache.h ${BASHINCDIR}/posixwait.h
expr.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h 
expr.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
expr.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
findcmd.o: config.h pshtypes.h ${BASHINCDIR}/filecntl.h ${BASHINCDIR}/posixstat.h pshansi.h
findcmd.o: ${BASHINCDIR}/ansi_stdlib.h ${BASHINCDIR}/memalloc.h shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h
...
flags.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
flags.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
flags.o: quit.h ${BASHINCDIR}/maxpath.h unwind_prot.h dispose_cmd.h execute_cmd.h
flags.o: make_cmd.h subst.h sig.h pathnames.h externs.h pshhist.h
flags.o: ${BASHINCDIR}/ocache.h ${BASHINCDIR}/chartypes.h pshansi.h assoc.h
general.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h ${BASHINCDIR}/filecntl.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
general.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
general.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
hashcmd.o: config.h ${BASHINCDIR}/posixstat.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
hashcmd.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
hashcmd.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashcmd.h
hashcmd.o: execute_cmd.h findcmd.h ${BASHINCDIR}/stdc.h pathnames.h hashlib.h
hashcmd.o: quit.h sig.h flags.h
hashlib.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
hashlib.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
hashlib.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
input.o: config.h pshtypes.h ${BASHINCDIR}/filecntl.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
input.o: command.h ${BASHINCDIR}/stdc.h general.h xmalloc.h input.h error.h externs.h
input.o: quit.h shell.h pathnames.h
list.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
list.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
list.o: quit.h ${BASHINCDIR}/maxpath.h unwind_prot.h dispose_cmd.h
list.o: make_cmd.h subst.h sig.h pathnames.h externs.h 
list.o: ${BASHINCDIR}/ocache.h ${BASHINCDIR}/chartypes.h pshansi.h assoc.h
locale.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
locale.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
locale.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
mailcheck.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
mailcheck.o: ${BASHINCDIR}/posixtime.h
mailcheck.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
mailcheck.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
make_cmd.o: config.h pshtypes.h ${BASHINCDIR}/filecntl.h pshansi.h
...
make_cmd.o: unwind_prot.h $(BASHINCDIR)/posixjmp.h pshjmp.h $(BASHINCDIR)/posixwait.h
y.tab.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h ${BASHINCDIR}/memalloc.h
y.tab.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
y.tab.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
y.tab.o: $(DEFDIR)/builtext.h pshline.h pshhist.h jobs.h siglist.h alias.h
...
pathexp.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
pathexp.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
pathexp.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
print_cmd.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
print_cmd.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
print_cmd.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
redir.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h ${BASHINCDIR}/filecntl.h
redir.o: ${BASHINCDIR}/memalloc.h shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
...
shell.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h ${BASHINCDIR}/filecntl.h
shell.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
shell.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
shell.o: jobs.h siglist.h input.h execute_cmd.h findcmd.h pshhist.h pshline.h
...
sig.o: config.h pshtypes.h
sig.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
sig.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
sig.o: jobs.h siglist.h trap.h $(DEFSRC)/common.h pshline.h pshhist.h
sig.o: ${DEFDIR}/builtext.h
siglist.o: config.h pshtypes.h siglist.h trap.h 
stringlib.o: pshtypes.h ${BASHINCDIR}/chartypes.h
stringlib.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
stringlib.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
stringlib.o: pshansi.h pathexp.h assoc.h $(BASHINCDIR)/ocache.h
stringlib.o: ${GLOB_LIBSRC}/glob.h ${GLOB_LIBSRC}/strmatch.h
subst.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h ${BASHINCDIR}/posixstat.h
subst.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
subst.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
subst.o: pshline.h pshhist.h ${GLOB_LIBSRC}/strmatch.h
subst.o: ${BASHINCDIR}/chartypes.h
subst.o: ${BASHINCDIR}/shmbutil.h ${BASHINCDIR}/shmbchar.h
subst.o: ${DEFDIR}/builtext.h
test.o: pshtypes.h ${BASHINCDIR}/posixstat.h ${BASHINCDIR}/filecntl.h
test.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
test.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
test.o: $(GLOB_LIBSRC)/strmatch.h pshansi.h pathexp.h assoc.h
test.o: ${DEFSRC}/common.h 
trap.o: config.h pshtypes.h trap.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
trap.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
trap.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
unwind_prot.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h command.h ${BASHINCDIR}/stdc.h
...
variables.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
variables.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
variables.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
variables.o: findcmd.h pshhist.h hashcmd.h pathexp.h
...
xmalloc.o: config.h pshtypes.h ${BASHINCDIR}/ansi_stdlib.h error.h
xmalloc.o: ${BASHINCDIR}/stdc.h $(ALLOC_LIBSRC)/shmalloc.h

# job control

jobs.o: config.h pshtypes.h trap.h ${BASHINCDIR}/filecntl.h input.h ${BASHINCDIR}/shtty.h
jobs.o: pshansi.h ${BASHINCDIR}/ansi_stdlib.h assoc.h
jobs.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
jobs.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
nojobs.o: config.h pshtypes.h ${BASHINCDIR}/filecntl.h pshjmp.h ${BASHINCDIR}/posixjmp.h
...
array.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
array.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
array.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
array2.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
array2.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
array2.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
arrayfunc.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
arrayfunc.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
arrayfunc.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
assoc.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
assoc.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h
assoc.o: command.h ${BASHINCDIR}/stdc.h error.h
assoc.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h
...
braces.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
braces.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
braces.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
...
alias.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h command.h ${BASHINCDIR}/stdc.h
alias.o: general.h xmalloc.h pshtypes.h externs.h alias.h
alias.o: pcomplete.h hashlib.h
alias.o: ${BASHINCDIR}/chartypes.h

pcomplib.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h pshtypes.h
pcomplib.o: ${BASHINCDIR}/stdc.h hashlib.h pcomplete.h shell.h syntax.h
pcomplib.o: pshjmp.h command.h general.h xmalloc.h error.h variables.h
...
pcomplete.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h pshtypes.h
pcomplete.o: ${BASHINCDIR}/stdc.h hashlib.h pcomplete.h shell.h syntax.h
pcomplete.o: pshjmp.h command.h general.h xmalloc.h error.h variables.h
pcomplete.o: execute_cmd.h pathexp.h arrayfunc.h conftypes.h quit.h trap.h
pcomplete.o: jobs.h siglist.h pshline.h alias.h
...
pshhist.o: config.h pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h ${BASHINCDIR}/posixstat.h
pshhist.o: ${BASHINCDIR}/filecntl.h
pshhist.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
pshhist.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
pshhist.o: quit.h ${BASHINCDIR}/maxpath.h unwind_prot.h dispose_cmd.h
pshhist.o: make_cmd.h subst.h sig.h pathnames.h externs.h parser.h
pshhist.o: flags.h input.h parser.h pathexp.h $(DEFSRC)/common.h pshline.h
pshhist.o: ${BASHINCDIR}/ocache.h ${BASHINCDIR}/chartypes.h pshhist.h assoc.h
pshhist.o: $(GLOB_LIBSRC)/strmatch.h ${GLOB_LIBSRC}/glob.h
pshline.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
pshline.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h command.h ${BASHINCDIR}/stdc.h error.h
pshline.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h array.h hashlib.h
pshline.o: quit.h ${BASHINCDIR}/maxpath.h unwind_prot.h dispose_cmd.h
pshline.o: make_cmd.h subst.h sig.h pathnames.h externs.h parser.h
pshline.o: builtins.h pshhist.h pshline.h execute_cmd.h findcmd.h pathexp.h
pshline.o: trap.h flags.h assoc.h $(BASHINCDIR)/ocache.h
pshline.o: $(DEFSRC)/common.h $(GLOB_LIBSRC)/glob.h alias.h
pshline.o: pcomplete.h ${BASHINCDIR}/chartypes.h input.h
pshline.o: ${BASHINCDIR}/shmbutil.h ${BASHINCDIR}/shmbchar.h
pshline.o: ${DEFDIR}/builtext.h
bracecomp.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
bracecomp.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h
bracecomp.o: command.h ${BASHINCDIR}/stdc.h error.h
bracecomp.o: general.h xmalloc.h pshtypes.h variables.h arrayfunc.h conftypes.h
...
bracecomp.o: ${BASHINCDIR}/ocache.h ${BASHINCDIR}/chartypes.h pshhist.h assoc.h
bracecomp.o: ${BASHINCDIR}/shmbutil.h ${BASHINCDIR}/shmbchar.h

# library dependencies

pshhist.o: $(RL_LIBSRC)/rltypedefs.h
pshline.o: $(RL_LIBSRC)/rlconf.h
pshline.o: $(RL_LIBSRC)/keymaps.h $(RL_LIBSRC)/rlstdc.h
pshline.o: $(RL_LIBSRC)/chardefs.h $(RL_LIBSRC)/readline.h
pshline.o: $(RL_LIBSRC)/rltypedefs.h ${RL_LIBSRC}/rlmbutil.h
...
pshline.o: $(HIST_LIBSRC)/history.h $(HIST_LIBSRC)/rlstdc.h
pshhist.o: $(HIST_LIBSRC)/history.h $(HIST_LIBSRC)/rlstdc.h
y.tab.o: $(HIST_LIBSRC)/history.h $(HIST_LIBSRC)/rlstdc.h
pcomplete.o: $(HIST_LIBSRC)/history.h $(HIST_LIBSRC)/rlstdc.h

pshline.o: $(TILDE_LIBSRC)/tilde.h
...
arrayfunc.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
pshhist.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
pshline.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
braces.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
error.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
eval.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
execute_cmd.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
expr.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
general.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
input.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
jobs.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
locale.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
mailcheck.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
make_cmd.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
nojobs.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
y.tab.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
pathexp.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
pcomplete.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
pcomplib.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
print_cmd.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
redir.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
shell.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
sig.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
siglist.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
subst.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
test.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
trap.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
variables.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
version.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
xmalloc.o: pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h

# XXX
$(MALLOC_SOURCE): pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h

signames.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h

# XXX - dependencies checked through here

# builtin c sources
builtins/pshgetopt.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
builtins/pshgetopt.o: shell.h syntax.h config.h pshjmp.h command.h general.h xmalloc.h error.h
builtins/pshgetopt.o: variables.h arrayfunc.h conftypes.h quit.h ${BASHINCDIR}/maxpath.h unwind_prot.h dispose_cmd.h
builtins/pshgetopt.o: make_cmd.h subst.h sig.h pathnames.h externs.h 
builtins/pshgetopt.o: $(DEFSRC)/common.h
builtins/pshgetopt.o: ${BASHINCDIR}/chartypes.h
builtins/common.o: pshtypes.h ${BASHINCDIR}/posixstat.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
builtins/common.o: shell.h syntax.h config.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h command.h
...
builtins/common.o: dispose_cmd.h make_cmd.h subst.h externs.h pshhist.h 
...
builtins/evalfile.o: pshtypes.h ${BASHINCDIR}/posixstat.h ${BASHINCDIR}/filecntl.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
builtins/evalfile.o: shell.h syntax.h config.h pshjmp.h command.h general.h xmalloc.h error.h
...
builtins/evalfile.o: pshhist.h $(DEFSRC)/common.h
builtins/evalstring.o: config.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
builtins/evalstring.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h command.h siglist.h
...
builtins/evalstring.o: pshhist.h $(DEFSRC)/common.h pathnames.h redir.h
builtins/evalstring.o: ${DEFDIR}/builtext.h
builtins/getopt.o: config.h ${BASHINCDIR}/memalloc.h
builtins/getopt.o: shell.h syntax.h pshjmp.h command.h general.h xmalloc.h error.h
...
builtins/mkbuiltins.o: config.h pshtypes.h ${BASHINCDIR}/posixstat.h ${BASHINCDIR}/filecntl.h
builtins/mkbuiltins.o: pshansi.h ${BASHINCDIR}/ansi_stdlib.h
...
builtins/alias.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h command.h ${BASHINCDIR}/stdc.h unwind_prot.h
...
builtins/bind.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
builtins/bind.o: $(DEFSRC)/pshgetopt.h pathnames.h
builtins/break.o: command.h config.h ${BASHINCDIR}/memalloc.h error.h general.h xmalloc.h ${BASHINCDIR}/maxpath.h
builtins/break.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
...
builtins/builtin.o: quit.h $(DEFSRC)/common.h $(DEFSRC)/pshgetopt.h
builtins/builtin.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/caller.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
builtins/caller.o: dispose_cmd.h make_cmd.h subst.h externs.h ${BASHINCDIR}/stdc.h
builtins/caller.o: $(DEFSRC)/common.h quit.h 
builtins/caller.o: ${BASHINCDIR}/chartypes.h pshtypes.h
...
builtins/cd.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
...
builtins/colon.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
...
builtins/command.o: quit.h $(DEFSRC)/pshgetopt.h
builtins/command.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/declare.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
builtins/declare.o: dispose_cmd.h make_cmd.h subst.h externs.h ${BASHINCDIR}/stdc.h
builtins/declare.o: $(DEFSRC)/pshgetopt.h pathnames.h flags.h
...
builtins/echo.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
...
builtins/enable.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
...
builtins/eval.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h 
builtins/eval.o: dispose_cmd.h make_cmd.h subst.h externs.h ${BASHINCDIR}/stdc.h
builtins/eval.o: pathnames.h
builtins/exec.o: pshtypes.h pathnames.h
builtins/exec.o: command.h config.h ${BASHINCDIR}/memalloc.h error.h general.h xmalloc.h ${BASHINCDIR}/maxpath.h
builtins/exec.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
builtins/exec.o: dispose_cmd.h make_cmd.h subst.h externs.h execute_cmd.h 
builtins/exec.o: findcmd.h flags.h quit.h $(DEFSRC)/common.h ${BASHINCDIR}/stdc.h
builtins/exec.o: pathnames.h
builtins/exit.o: pshtypes.h 
builtins/exit.o: command.h config.h ${BASHINCDIR}/memalloc.h error.h general.h xmalloc.h ${BASHINCDIR}/maxpath.h
builtins/exit.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
...
builtins/fc.o: pshtypes.h ${BASHINCDIR}/posixstat.h
builtins/fc.o: pshansi.h ${BASHINCDIR}/ansi_stdlib.h builtins.h command.h ${BASHINCDIR}/stdc.h 
builtins/fc.o: command.h config.h ${BASHINCDIR}/memalloc.h error.h general.h xmalloc.h ${BASHINCDIR}/maxpath.h
builtins/fc.o: flags.h unwind_prot.h variables.h arrayfunc.h conftypes.h shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h 
builtins/fc.o: dispose_cmd.h make_cmd.h subst.h externs.h ${BASHINCDIR}/stdc.h quit.h 
builtins/fc.o: $(DEFSRC)/pshgetopt.h pshhist.h pathnames.h parser.h
builtins/fc.o: ${BASHINCDIR}/chartypes.h
builtins/fg_bg.o: pshtypes.h $(DEFSRC)/pshgetopt.h 
builtins/fg_bg.o: command.h config.h ${BASHINCDIR}/memalloc.h error.h general.h xmalloc.h ${BASHINCDIR}/maxpath.h
builtins/fg_bg.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h
...
builtins/getopts.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h 
...
builtins/hash.o: pshtypes.h execute_cmd.h
...
builtins/hash.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h 
...
builtins/help.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h
builtins/help.o: conftypes.h quit.h execute_cmd.h
builtins/help.o: $(GLOB_LIBSRC)/glob.h pathnames.h
builtins/history.o: pshtypes.h pathnames.h parser.h
...
builtins/history.o: ${BASHINCDIR}/filecntl.h shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h
builtins/history.o: pshhist.h variables.h arrayfunc.h conftypes.h 
builtins/inlib.o: command.h config.h ${BASHINCDIR}/memalloc.h error.h general.h xmalloc.h ${BASHINCDIR}/maxpath.h
builtins/inlib.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h quit.h 
...
builtins/jobs.o: quit.h $(DEFSRC)/pshgetopt.h
builtins/jobs.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/kill.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h trap.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/let.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
builtins/let.o: pathnames.h
builtins/printf.o: config.h ${BASHINCDIR}/memalloc.h pshjmp.h command.h error.h
...
builtins/printf.o: variables.h arrayfunc.h conftypes.h ${BASHINCDIR}/stdc.h $(DEFSRC)/pshgetopt.h
...
builtins/pushd.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
...
builtins/read.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/return.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/set.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h flags.h
...
builtins/setattr.o: quit.h $(DEFSRC)/common.h $(DEFSRC)/pshgetopt.h
builtins/setattr.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/shift.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/shopt.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h unwind_prot.h variables.h arrayfunc.h conftypes.h ${BASHINCDIR}/maxpath.h
builtins/shopt.o: $(DEFSRC)/common.h $(DEFSRC)/pshgetopt.h pathnames.h
builtins/shopt.o: pshhist.h pshline.h
...
builtins/source.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
builtins/source.o: findcmd.h $(DEFSRC)/pshgetopt.h flags.h trap.h
...
builtins/suspend.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/test.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/times.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/trap.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/type.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
...
builtins/ulimit.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/umask.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
...
builtins/wait.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h
builtins/wait.o: execute_cmd.h
builtins/wait.o: ${BASHINCDIR}/chartypes.h pathnames.h

builtins/complete.o: config.h shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h
builtins/complete.o: unwind_prot.h variables.h arrayfunc.h conftypes.h
builtins/complete.o: pshtypes.h pshansi.h ${BASHINCDIR}/ansi_stdlib.h
builtins/complete.o: builtins.h pathnames.h general.h
builtins/complete.o: pshtypes.h ${BASHINCDIR}/chartypes.h xmalloc.h
builtins/complete.o: pcomplete.h
builtins/complete.o: ${DEFSRC}/common.h ${DEFSRC}/pshgetopt.h
...
builtins/mapfile.o: shell.h syntax.h pshjmp.h ${BASHINCDIR}/posixjmp.h sig.h unwind_prot.h variables.h arrayfunc.h conftypes.h 
builtins/mapfile.o: pathnames.h

# libintl dependencies
builtins/bind.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/break.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/caller.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/cd.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/common.c: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/complete.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/declare.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/enable.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/evalfile.c: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/exec.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/exit.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/fc.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/fg_bg.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/getopt.c: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/hash.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/help.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/history.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/inlib.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/jobs.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/kill.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/let.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/mapfile.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/mkbuiltins.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/printf.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/pushd.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/read.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/return.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/set.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/setattr.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/shift.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/shopt.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/source.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/suspend.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/type.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/ulimit.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
builtins/umask.o: ${topdir}/pshintl.h ${LIBINTL_H} $(BASHINCDIR)/gettext.h
