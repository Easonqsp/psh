...
#line 21 "/usr/local/src/chet/src/psh/src/parse.y"
...
union YYSTYPE
{
#line 338 "/usr/local/src/chet/src/psh/src/parse.y"
...
#line 396 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 407 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1966 "y.tab.c"
  ...
  case 4: /* inputunit: '\n'  */
#line 415 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 424 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 439 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 456 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 466 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.word_list) = make_word_list ((yyvsp[0].word), (WORD_LIST *)NULL); }
#line 2037 "y.tab.c"
    break;

  case 9: /* word_list: word_list WORD  */
#line 468 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.word_list) = make_word_list ((yyvsp[0].word), (yyvsp[-1].word_list)); }
#line 2043 "y.tab.c"
    break;

  case 10: /* redirection: '>' WORD  */
#line 472 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
...
#line 478 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.filename = (yyvsp[0].word);
...
#line 484 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 490 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_input_direction, redir, 0);
...
#line 496 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 502 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 508 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.filename = (yyvsp[0].word);
...
#line 514 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_appending_to, redir, 0);
...
#line 520 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 526 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.filename = (yyvsp[0].word);
...
#line 532 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_output_force, redir, 0);
...
#line 538 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 544 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.filename = (yyvsp[0].word);
...
#line 550 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_input_output, redir, 0);
...
#line 556 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 562 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.filename = (yyvsp[0].word);
...
#line 569 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_reading_until, redir, 0);
...
#line 576 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 583 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.filename = (yyvsp[0].word);
...
#line 590 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_deblank_reading_until, redir, 0);
...
#line 597 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 604 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.filename = (yyvsp[0].word);
...
#line 610 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_reading_string, redir, 0);
...
#line 616 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 622 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
...
#line 628 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.dest = (yyvsp[0].number);
			  (yyval.redirect) = make_redirection (source, r_duplicating_input, redir, 0);
...
#line 634 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.dest = (yyvsp[0].number);
...
#line 640 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.dest = (yyvsp[0].number);
...
#line 646 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.dest = (yyvsp[0].number);
			  (yyval.redirect) = make_redirection (source, r_duplicating_output, redir, 0);
...
#line 652 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.dest = (yyvsp[0].number);
...
#line 658 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.filename = (yyvsp[0].word);
...
#line 664 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_duplicating_input_word, redir, 0);
...
#line 670 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 676 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.filename = (yyvsp[0].word);
...
#line 682 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.filename = (yyvsp[0].word);
			  (yyval.redirect) = make_redirection (source, r_duplicating_output_word, redir, 0);
...
#line 688 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.filename = (yyvsp[0].word);
...
#line 694 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.dest = 0;
...
#line 700 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.dest = 0;
			  (yyval.redirect) = make_redirection (source, r_close_this, redir, 0);
...
#line 706 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.dest = 0;
...
#line 712 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 0;
			  redir.dest = 0;
			  (yyval.redirect) = make_redirection (source, r_close_this, redir, 0);
...
#line 718 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = (yyvsp[-2].number);
			  redir.dest = 0;
			  (yyval.redirect) = make_redirection (source, r_close_this, redir, 0);
...
#line 724 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.filename = (yyvsp[-2].word);
			  redir.dest = 0;
			  (yyval.redirect) = make_redirection (source, r_close_this, redir, REDIR_VARASSIGN);
...
#line 730 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.filename = (yyvsp[0].word);
...
#line 736 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  source.dest = 1;
			  redir.filename = (yyvsp[0].word);
...
#line 744 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.element).word = (yyvsp[0].word); (yyval.element).redirect = 0; }
#line 2495 "y.tab.c"
    break;

  case 55: /* simple_command_element: ASSIGNMENT_WORD  */
#line 746 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.element).word = (yyvsp[0].word); (yyval.element).redirect = 0; }
#line 2501 "y.tab.c"
    break;

  case 56: /* simple_command_element: redirection  */
#line 748 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.element).redirect = (yyvsp[0].redirect); (yyval.element).word = 0; }
#line 2507 "y.tab.c"
    break;

  case 57: /* redirection_list: redirection  */
#line 752 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 756 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  register REDIRECT *t;
...
#line 767 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = make_simple_command ((yyvsp[0].element), (COMMAND *)NULL); }
#line 2534 "y.tab.c"
    break;

  case 60: /* simple_command: simple_command simple_command_element  */
#line 769 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = make_simple_command ((yyvsp[0].element), (yyvsp[-1].command)); }
#line 2540 "y.tab.c"
    break;

  case 61: /* command: simple_command  */
#line 773 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = clean_simple_command ((yyvsp[0].command)); }
#line 2546 "y.tab.c"
    break;

  case 62: /* command: shell_command  */
#line 775 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2552 "y.tab.c"
    break;

  case 63: /* command: shell_command redirection_list  */
#line 777 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  COMMAND *tc;
...
#line 793 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2578 "y.tab.c"
    break;

  case 65: /* command: coproc  */
#line 795 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2584 "y.tab.c"
    break;

  case 66: /* shell_command: for_command  */
#line 799 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2590 "y.tab.c"
    break;

  case 67: /* shell_command: case_command  */
#line 801 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2596 "y.tab.c"
    break;

  case 68: /* shell_command: WHILE compound_list DO compound_list DONE  */
#line 803 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = make_while_command ((yyvsp[-3].command), (yyvsp[-1].command)); }
#line 2602 "y.tab.c"
    break;

  case 69: /* shell_command: UNTIL compound_list DO compound_list DONE  */
#line 805 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = make_until_command ((yyvsp[-3].command), (yyvsp[-1].command)); }
#line 2608 "y.tab.c"
    break;

  case 70: /* shell_command: select_command  */
#line 807 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2614 "y.tab.c"
    break;

  case 71: /* shell_command: if_command  */
#line 809 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2620 "y.tab.c"
    break;

  case 72: /* shell_command: subshell  */
#line 811 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2626 "y.tab.c"
    break;

  case 73: /* shell_command: group_command  */
#line 813 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2632 "y.tab.c"
    break;

  case 74: /* shell_command: arith_command  */
#line 815 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2638 "y.tab.c"
    break;

  case 75: /* shell_command: cond_command  */
#line 817 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2644 "y.tab.c"
    break;

  case 76: /* shell_command: arith_for_command  */
#line 819 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2650 "y.tab.c"
    break;

  case 77: /* for_command: FOR WORD newline_list DO compound_list DONE  */
#line 823 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 828 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_for_command ((yyvsp[-4].word), add_string_to_list ("\"$@\"", (WORD_LIST *)NULL), (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 833 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 838 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_for_command ((yyvsp[-5].word), add_string_to_list ("\"$@\"", (WORD_LIST *)NULL), (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 843 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 848 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_for_command ((yyvsp[-8].word), REVERSE_LIST ((yyvsp[-5].word_list), WORD_LIST *), (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 853 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 858 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_for_command ((yyvsp[-7].word), (WORD_LIST *)NULL, (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 865 "/usr/local/src/chet/src/psh/src/parse.y"
                                {
...
#line 871 "/usr/local/src/chet/src/psh/src/parse.y"
                                {
				  (yyval.command) = make_arith_for_command ((yyvsp[-5].word_list), (yyvsp[-1].command), arith_for_lineno);
				  if ((yyval.command) == 0) YYERROR;
				  if (word_top > 0) word_top--;
...
#line 877 "/usr/local/src/chet/src/psh/src/parse.y"
                                {
...
#line 883 "/usr/local/src/chet/src/psh/src/parse.y"
                                {
				  (yyval.command) = make_arith_for_command ((yyvsp[-3].word_list), (yyvsp[-1].command), arith_for_lineno);
				  if ((yyval.command) == 0) YYERROR;
				  if (word_top > 0) word_top--;
...
#line 891 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 896 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_select_command ((yyvsp[-4].word), add_string_to_list ("\"$@\"", (WORD_LIST *)NULL), (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 901 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 906 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_select_command ((yyvsp[-5].word), add_string_to_list ("\"$@\"", (WORD_LIST *)NULL), (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 911 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 916 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_select_command ((yyvsp[-8].word), REVERSE_LIST ((yyvsp[-5].word_list), WORD_LIST *), (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 921 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 926 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = make_select_command ((yyvsp[-7].word), (WORD_LIST *)NULL, (yyvsp[-1].command), word_lineno[word_top]);
			  if (word_top > 0) word_top--;
			}
...
#line 933 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 938 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 943 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 950 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = make_function_def ((yyvsp[-4].word), (yyvsp[0].command), function_dstart, function_bstart); }
#line 2867 "y.tab.c"
    break;

  case 101: /* function_def: FUNCTION WORD '(' ')' newline_list function_body  */
#line 952 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = make_function_def ((yyvsp[-4].word), (yyvsp[0].command), function_dstart, function_bstart); }
#line 2873 "y.tab.c"
    break;

  case 102: /* function_def: FUNCTION WORD function_body  */
#line 954 "/usr/local/src/chet/src/psh/src/parse.y"
...
#line 956 "/usr/local/src/chet/src/psh/src/parse.y"
...
#line 960 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2891 "y.tab.c"
    break;

  case 105: /* function_body: shell_command redirection_list  */
#line 962 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  COMMAND *tc;
...
#line 993 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1000 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = (yyvsp[-1].command);
			}
#line 2941 "y.tab.c"
...
#line 1004 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1010 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1015 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  COMMAND *tc;
...
#line 1032 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1037 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  COMMAND *tc;
...
#line 1054 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1111 "/usr/local/src/chet/src/psh/src/parse.y"
...
#line 1113 "/usr/local/src/chet/src/psh/src/parse.y"
...
#line 1115 "/usr/local/src/chet/src/psh/src/parse.y"
...
#line 1119 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.word_list) = make_word_list ((yyvsp[0].word), (WORD_LIST *)NULL); }
#line 3144 "y.tab.c"
    break;

  case 136: /* pattern: pattern '|' WORD  */
#line 1121 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.word_list) = make_word_list ((yyvsp[0].word), (yyvsp[-2].word_list)); }
#line 3150 "y.tab.c"
    break;

  case 137: /* compound_list: newline_list list0  */
#line 1130 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = (yyvsp[0].command);
...
#line 1136 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = (yyvsp[0].command);
			}
#line 3168 "y.tab.c"
...
#line 1143 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1154 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), AND_AND); }
#line 3185 "y.tab.c"
    break;

  case 143: /* list1: list1 OR_OR newline_list list1  */
#line 1156 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), OR_OR); }
#line 3191 "y.tab.c"
    break;

  case 144: /* list1: list1 '&' newline_list list1  */
#line 1158 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1165 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), ';'); }
#line 3208 "y.tab.c"
    break;

  case 146: /* list1: list1 '\n' newline_list list1  */
#line 1167 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  if (parser_state & PST_CMDSUBST)
			    (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), '\n');
			  else
...
#line 1174 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3225 "y.tab.c"
    break;

  case 150: /* list_terminator: '\n'  */
#line 1182 "/usr/local/src/chet/src/psh/src/parse.y"
                { (yyval.number) = '\n'; }
#line 3231 "y.tab.c"
    break;

  case 151: /* list_terminator: ';'  */
#line 1184 "/usr/local/src/chet/src/psh/src/parse.y"
                { (yyval.number) = ';'; }
#line 3237 "y.tab.c"
    break;

  case 152: /* list_terminator: yacc_EOF  */
#line 1186 "/usr/local/src/chet/src/psh/src/parse.y"
                { (yyval.number) = yacc_EOF; }
#line 3243 "y.tab.c"
    break;

  case 155: /* simple_list: simple_list1  */
#line 1200 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = (yyvsp[0].command);
			  if (need_here_doc)
...
#line 1215 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1233 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  (yyval.command) = (yyvsp[-1].command);
			  if (need_here_doc)
			    gather_here_documents ();	/* XXX */
...
#line 1250 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), AND_AND); }
#line 3309 "y.tab.c"
    break;

  case 159: /* simple_list1: simple_list1 OR_OR newline_list simple_list1  */
#line 1252 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), OR_OR); }
#line 3315 "y.tab.c"
    break;

  case 160: /* simple_list1: simple_list1 '&' simple_list1  */
#line 1254 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  if ((yyvsp[-2].command)->type == cm_connection)
...
#line 1261 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-2].command), (yyvsp[0].command), ';'); }
#line 3332 "y.tab.c"
    break;

  case 162: /* simple_list1: pipeline_command  */
#line 1264 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3338 "y.tab.c"
    break;

  case 163: /* pipeline_command: pipeline  */
#line 1268 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3344 "y.tab.c"
    break;

  case 164: /* pipeline_command: BANG pipeline_command  */
#line 1270 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  if ((yyvsp[0].command))
...
#line 1276 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  if ((yyvsp[0].command))
...
#line 1282 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  ELEMENT x;
...
#line 1302 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
			  ELEMENT x;
...
#line 1325 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), '|'); }
#line 3419 "y.tab.c"
    break;

  case 169: /* pipeline: pipeline BAR_AND newline_list pipeline  */
#line 1327 "/usr/local/src/chet/src/psh/src/parse.y"
                        {
...
#line 1350 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3452 "y.tab.c"
    break;

  case 171: /* timespec: TIME  */
#line 1354 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE; }
#line 3458 "y.tab.c"
    break;

  case 172: /* timespec: TIME TIMEOPT  */
#line 1356 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE|CMD_TIME_POSIX; }
#line 3464 "y.tab.c"
    break;

  case 173: /* timespec: TIME TIMEIGN  */
#line 1358 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE|CMD_TIME_POSIX; }
#line 3470 "y.tab.c"
    break;

  case 174: /* timespec: TIME TIMEOPT TIMEIGN  */
#line 1360 "/usr/local/src/chet/src/psh/src/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE|CMD_TIME_POSIX; }
#line 3476 "y.tab.c"
    break;
...
#line 1362 "/usr/local/src/chet/src/psh/src/parse.y"
...
#define SHOULD_PROMPT() \
  (interactive && (psh_input.type == st_stdin || psh_input.type == st_stream))
...
BASH_INPUT psh_input;

/* Set all of the fields in BASH_INPUT to NULL.  Free psh_input.name if it
   is non-null, avoiding a memory leak. */
void
initialize_psh_input ()
{
  psh_input.type = st_none;
  FREE (psh_input.name);
  psh_input.name = (char *)NULL;
  psh_input.location.file = (FILE *)NULL;
  psh_input.location.string = (char *)NULL;
  psh_input.getter = (sh_cget_func_t *)NULL;
  psh_input.ungetter = (sh_cunget_func_t *)NULL;
}

/* Set the contents of the current psh input stream from
     ...
     INPUT_STREAM location;
{
  psh_input.type = type;
  FREE (psh_input.name);
  psh_input.name = name ? savestring (name) : (char *)NULL;

  /* XXX */
#if defined (CRAY)
  memcpy((char *)&psh_input.location.string, (char *)&location.string, sizeof(location));
#else
  psh_input.location = location;
#endif
  psh_input.getter = get;
  psh_input.ungetter = unget;
}

char *
yy_input_name ()
{
  return (psh_input.name ? psh_input.name : "stdin");
}
...
{
  switch (psh_input.type)
    {
    case st_stream:
      return (fileno (psh_input.location.file));
    case st_bstream:
      return (psh_input.location.buffered_fd);
    case st_stdin:
    default:
      return (fileno (stdin));
    }
...
with_input_from_stdin ()
{
  ...
  if (psh_input.type != st_stdin && stream_on_stack (st_stdin) == 0)
    {
...
yy_string_get ()
{
  ...
  string = psh_input.location.string;

  /* If the string doesn't exist, or is empty, EOF found. */
  if (string && *string)
    {
      c = *string++;
      psh_input.location.string = string;
      return (c);
    }
  else
    return (EOF);
...
/* Count the number of characters we've consumed from psh_input.location.string
   and read into shell_input_line, but have not returned from shell_getc.
   That is the true input location.  Rewind psh_input.location.string by
...
rewind_input_string ()
{
  ...
  if (psh_input.location.string[-1] == '\n')
    xchars++;

  /* XXX - how to reflect psh_input.location.string back to string passed to
     parse_and_execute or xparse_dolparen? xparse_dolparen needs to know how
     far into the string we parsed.  parse_and_execute knows where psh_input.
     location.string is, and how far from orig_string that is -- that's the
     number of characters the command consumed. */

  /* psh_input.location.string - xchars should be where we parsed to */
  /* need to do more validation on xchars value for sanity -- test cases. */
  psh_input.location.string -= xchars;
}
...
/* These two functions used to test the value of the HAVE_RESTARTABLE_SYSCALLS
   define, and just use getc/ungetc if it was defined, but since psh
...
yy_stream_get ()
{
  ...
  result = EOF;
  if (psh_input.location.file)
    {
      /* XXX - don't need terminate_immediately; getc_with_restart checks
	 for terminating signals itself if read returns < 0 */
      result = getc_with_restart (psh_input.location.file);
    }
  return (result);
}
...
yy_stream_unget (c)
     int c;
{
  return (ungetc_with_restart (c, psh_input.location.file));
}
     ...
     int reset_lineno;
{
  ...
  xbcopy ((char *)&psh_input, (char *)&(saver->psh_input), sizeof (BASH_INPUT));

#if defined (BUFFERED_INPUT)
  saver->bstream = (BUFFERED_STREAM *)NULL;
  /* If we have a buffered stream, clear out buffers[fd]. */
  if (psh_input.type == st_bstream && psh_input.location.buffered_fd >= 0)
    saver->bstream = set_buffered_stream (psh_input.location.buffered_fd,
...
pop_stream ()
{
  if (!stream_list)
  ...
  else
    {
      ...
      init_yy_io (saver->psh_input.getter,
		  saver->psh_input.ungetter,
		  saver->psh_input.type,
		  saver->psh_input.name,
		  saver->psh_input.location);

#if defined (BUFFERED_INPUT)
      /* If we have a buffered stream, restore buffers[fd]. */
      /* If the input file descriptor was changed while this was on the
	 save stack, update the buffered fd to the new file descriptor and
	 re-establish the buffer <-> psh_input fd correspondence. */
      if (psh_input.type == st_bstream && psh_input.location.buffered_fd >= 0)
	{
	  if (psh_input_fd_changed)
	    {
	      psh_input_fd_changed = 0;
	      if (default_buffered_input >= 0)
		{
		  psh_input.location.buffered_fd = default_buffered_input;
		  saver->bstream->b_fd = default_buffered_input;
		  SET_CLOSE_ON_EXEC (default_buffered_input);
		}
	    }
	  /* XXX could free buffered stream returned as result here. */
	  set_buffered_stream (psh_input.location.buffered_fd, saver->bstream);
	}
#endif /* BUFFERED_INPUT */

      line_number = saver->line;

      FREE (saver->psh_input.name);
      free (saver);
    }
}
     ...
     int remove_quoted_newline;
{
  ...
  while (1)
	...
	continue;
      ...
      if (c == EOF)
	{
	  if (interactive && psh_input.type == st_stream)
	    clearerr (stdin);
	  if (indx == 0)
	    return ((char *)NULL);
	  c = '\n';
...
#  endif
      ...
      if (shell_input_line_terminator != EOF)
	{
	  ...
	  /* Don't add a newline to a string that ends with a backslash if we're
	     ...
	     word expansion). */
	  if (psh_input.type == st_string && expanding_alias() == 0 && last_was_backslash && c == EOF && remove_quoted_newline)
...
pop_alias:
  ...
  if (uc == 0 && psh_input.type == st_string && *psh_input.location.string &&
     ...
     int command;
{
 ...
 re_read_token:
  ...
  if (character == '\0' && psh_input.type == st_string && expanding_alias() == 0)
    {
      INTERNAL_DEBUG (("shell_getc: psh_input.location.string = `%s'", psh_input.location.string));
      EOF_Reached = 1;
      return (yacc_EOF);
    }
  ...
  if (nc < 0)
    {
      ...
      if (psh_input.type != st_string)	/* paranoia */
...
/* Return a string which will be printed as a prompt.  The string
   may contain special characters which are decoded as follows:
	...
	\u	your username
	\v	the version of psh (e.g., 2.00)
	\V	the release of psh, version + patchlevel (e.g., 2.00.0)
